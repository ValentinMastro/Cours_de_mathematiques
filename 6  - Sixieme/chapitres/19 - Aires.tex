...
\begin{questions}
    ...
    \question 
        \subpart \qty{54}{dm\squared} = 
        \subpart \qty{75}{cm\squared} = 
        \subpart \qty{250}{dam\squared} = 
        \subpart \qty{0,25}{km\squared} = 
        \subpart \qty{7}{hm\squared} = 
        \subpart \qty{2750}{mm\squared} = 
\end{questions}
