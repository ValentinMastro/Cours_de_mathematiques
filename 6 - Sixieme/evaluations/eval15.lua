...
local function perimetre_cercle()
    ...
    local enonce = compresser(50, scriptsize("Calculer le périmètre d'un cercle de rayon \\qty{" .. r .. " }{\\centi\\metre}."))
...
local function perimetre_cercle_diametre()
    ...
    local enonce = compresser(50, scriptsize("Calculer le périmètre d'un cercle de diamètre \\qty{" .. d .. " }{\\centi\\metre}."))
...
local function perimetre_carre()
    ...
    local enonce = scriptsize("Calculer le périmètre d'un carré de côté \\qty{" .. c .. "}{\\centi\\metre}.")
...
local function aire_disque()
    ...
    local enonce = scriptsize("\\spacedstyle{-50}Calculer l'aire d'un disque de rayon \\qty{" .. r .. "}{\\centi\\metre}.\\normalstyle{}")
...
local function aire_carre()
    ...
    local enonce = scriptsize("Calculer l'aire d'un carré de côté \\qty{" .. c .. "}{\\centi\\metre}.")
...
local function aire_rectangle()
    ...
    local enonce = scriptsize("\\spacedstyle{-25}Calculer l'aire d'un rectangle de longueur $L=\\qty{" .. L .. "}{\\centi\\metre}$ et de largeur $\\ell=\\qty{" .. l .. "}{\\centi\\metre}$.\\normalstyle{}")
    local reponses = map(scriptsize, map(qty_cm2,
            {L*l, 2*L+2*l, L+l, l, L}
    ))
...
local function aire_losange()
    ...
    local enonce = scriptsize("\\spacedstyle{-25}Calculer l'aire d'un losange de grande diagonale $D=\\qty{" .. D .. "}{\\centi\\metre}$ et de petite diagonale $d=\\qty{" .. d .. "}{\\centi\\metre}$.\\normalstyle{}")
    local reponses = map(scriptsize, map(qty_cm2,
...
local function aire_triangle()
    ...
    local enonce = compresser(25, scriptsize("Calculer l'aire d'un triangle de base $b=\\qty{" .. b .. "}{\\centi\\metre}$ et de hauteur $h=\\qty{" .. h .. "}{\\centi\\metre}$."))
    local reponses = map(scriptsize, map(qty_cm2,
