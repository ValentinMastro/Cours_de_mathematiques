...
\begin{questions}
    ...
    \begin{centre}
        \begin{tikzpicture}[scale=0.4]
            \draw (0,0) -- (0,6) node[rouge,midway,left]{6} -- (8,0) node[rouge,midway,above right]{10} -- cycle node[rouge,midway,below]{8};
            \filldraw[noir] (0,0) rectangle +(0.7,0.7);
            \filldraw[green] (0,6) -- +(0,-0.6) arc(-90:-45:0.6);
        \end{tikzpicture}
        \begin{tikzpicture}[scale=0.4]
            \draw (0,0) -- (0,5) node[rouge,midway,left]{5} -- (12,0) node[rouge,midway,above right]{13} -- cycle node[rouge,midway,below]{12};
            \filldraw[noir] (0,0) rectangle +(0.7,0.7);
            \filldraw[green] (0,5) -- +(0,-0.6) arc(-90:-35:0.6);
        \end{tikzpicture}
        \begin{tikzpicture}[scale=0.15]
            \draw (0,0) -- (0,12) node[rouge,midway,left]{12} -- (35,0) node[rouge,midway,above right]{37} -- cycle node[rouge,midway,below]{35};
    ...
    \begin{centre}
        \begin{tikzpicture}[scale=0.4]
            \draw (0,0) -- (0,7) node[rouge,midway,left]{7} -- (13.1,0) node[rouge,midway,above right]{15} -- cycle;
            \filldraw[noir] (0,0) rectangle +(0.7,0.7);
