...
return { qA = puissances, qB = ecriture_scientifique, qC = calcul_thales, qD = rapport_thales_classique, qE = double_developpement, qF = factoriser2, qG = signe_puissances, qH = calcul_cote_angle_droit, qI = mediane3, qJ = mediane4, qK = moyenne4 }