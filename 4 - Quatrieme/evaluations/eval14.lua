...
local function cosinus_angle()
    ...
    local reponses = map(small, map(ang, map(arrondi2, {math.acos(adj/hyp)*180/math.pi, math.asin(adj/hyp)*180/math.pi, math.acos(adj/hyp)*90/math.pi, math.asin(adj/hyp)*90/math.pi, adj/hyp})))
...
return { qA = puissances, qB = ecriture_scientifique, qC = calcul_thales, qD = rapport_thales_classique, qE = double_developpement, qF = factoriser2, qG = signe_puissances, qH = calcul_cote_angle_droit, qI = mediane3, qJ = mediane4, qK = moyenne4, qL = cosinus_angle, qM = cosinus_hyp }