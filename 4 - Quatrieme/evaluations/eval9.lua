...
return { qA = calcul_hypotenuse, qB = calcul_cote_angle_droit, qC = factoriser, qD = factoriser2, qE = augmentation_pourcentage, qF = diminution_pourcentage, qG = double_developpement, qH = double_developpement_signes }