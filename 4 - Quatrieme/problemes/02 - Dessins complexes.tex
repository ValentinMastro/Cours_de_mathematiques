...
\clearpage
\PARTIETITRE{Dessins sur scratch}
...
\question 
    \subquestion Construire un hexagone régulier (tous les côtés et tous les angles égaux)
    \subquestion Construire un rectangle de dimensions $60\times40$.
    \subquestion Construire un trapèze.

\question Reproduire les figures suivantes à l'aide de scratch.

\begin{center}
    \begin{tikzpicture}
        \foreach \x in {1,2,3,4} {
            \draw (\x,0) rectangle (\x+3,1);
        }
    \end{tikzpicture}
