...
local function angle_manquant2()
    ...
    local c1 = "$\\widehat{" .. p1 .. p2 .. p3 .. "} {=} \\ang{" .. a .. "}$"
    local c2 = "$\\widehat{" .. p2 .. p3 .. p1 .. "} {=} \\ang{" .. b .. "}$"
    local c3 = "$\\widehat{" .. p3 .. p1 .. p2 .. "} {=} ?$"

    local enonce = "\\tiny{" .. c1 .. " et " .. c2 .. ", " .. c3 .."}"
...
local function angle_manquant3()
    local a = 90
    local b = math.random(10, 89)
    local rep = 180 - a - b
    ...
    local c1 = "$" .. p1 .. p2 .. p3 .. "$ est un triangle rectangle en $" .. p1 .. "$"
    local c2 = "$\\widehat{" .. p2 .. p3 .. p1 .. "} {=} \\ang{" .. b .. "}$"
    local c3 = "$\\widehat{" .. p3 .. p2 .. p1 .. "} {=} ?$"

    local enonce = c1 .. " et " .. c2 .. ", " .. c3
...
return { qA = angle_manquant, qB = mediatrice, qC = proportion_32_cartes, qD = multiplication_aleatoire, qE = divpar11, qF = cours_triangle_isocele, qG = triangle, qH = multiplication_avec_simplification, qI = hauteur}