...
return { qA = evaluer_expression, qB = trouver_diviseur, qC = decomposition_facteurs_premiers, qD = somme_ou_produit, qE = diviseur_10, qF = multiplication_avec_simplification, qG = triangle, qH = ratio}