...
return { qA = angle_manquant, qB = tableau_proportionnalite, qC = proportion_32_cartes, qD = multiplication_aleatoire, qE = divpar11, qF = egalite_fraction, qG = triangle, qH = multiplication_avec_simplification, qI = addition_fractions}