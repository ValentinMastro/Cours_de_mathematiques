...
return { qA = cours_triangle_isocele, qB = trouver_diviseur, qC = decomposition_facteurs_premiers, qD = angle_manquant, qE = diviseur_10, qF = multiplication_avec_simplification, qG = triangle, qH = ratio}